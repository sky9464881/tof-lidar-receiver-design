...
//20111021/1123016/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MAX3267CSA+" (originalName "MAX3267CSA+")
	...
	(compDef "MAX3267CSA+" (originalName "MAX3267CSA+") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "FILTER") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "GND_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MAX3267CSA+"))
		...
		(attr "Manufacturer_Part_Number" "MAX3267CSA+")
		(attr "Mouser Part Number" "")
		(attr "Mouser Price/Stock" "")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "The MAX3266 is a transimpedance preamplifier for 1.25Gbps local area network (LAN) fiber optic receivers. The circuit features 200nA input-referred noise, 920MHz bandwidth, and 1mA input overload.")
		(attr "<Hyperlink>" "https://www.analog.com/media/en/technical-documentation/data-sheets/MAX3266-MAX3267.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MAX3267CSA+.stp")
