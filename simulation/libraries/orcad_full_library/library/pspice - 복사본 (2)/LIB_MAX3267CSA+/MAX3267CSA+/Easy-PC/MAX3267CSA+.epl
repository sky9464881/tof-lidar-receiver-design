...
(library Library_1
	...
	(compDef "MAX3267CSA+" (originalName "MAX3267CSA+") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "FILTER") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "GND_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.analog.com/media/en/technical-documentation/data-sheets/MAX3266-MAX3267.pdf")
		(attr "Height" "1.75 mm")
	)
