...
//415597/1123016/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "OPA659IDBVT" (originalName "OPA659IDBVT")
	...
	(compDef "OPA659IDBVT" (originalName "OPA659IDBVT") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "INVERTING INPUT") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "+VS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "OPA659IDBVT"))
		...
		(attr "Manufacturer_Part_Number" "OPA659IDBVT")
		(attr "Mouser Part Number" "595-OPA659IDBVT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/OPA659IDBVT?qs=IDSsxkoac0yQx%2FRcNbdWsA%3D%3D")
		(attr "Arrow Part Number" "OPA659IDBVT")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/opa659idbvt/texas-instruments?region=nac")
		(attr "Description" "Texas Instruments OPA659IDBVT JFET Op Amp, 350MHz, 5-Pin SOT-23")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/opa659")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "OPA659IDBVT.stp")
